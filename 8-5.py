#### 실전 문제 : 1로 만들기
#### 정수 x가 주어질떄 정수 x에 사용할 수 있는 연산은 다음과 같이 4가지이다
...
## 1. 26 - 1 = 25, 2. 25 / 5 = 5, 3. 5 / 5 = 1

## 입력 조건 - 첫쨰 줄에 정수 x가 주어진다. (1 <= x <= 30,000)      - 입력 에시 : 26
## 출력 조건 - 첫쨰 줄에 연산을 하는 횟수의 최솟값을 출력한다.          - 출력 예시 : 3
